...
const Home = () => {
       ...
       return (
              <div className="space-y-24 pb-24">
                     {/* Hero Section */}
                     <section className="relative h-[600px] flex items-center overflow-hidden rounded-[40px] bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800">
                            ...
                            <div className="relative z-10 max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-12 items-center">
                                   <div className="text-white space-y-8">
                                          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
                                                 ...
                                                 <span className="text-sm font-bold tracking-wide">Available 24/7 for you</span>
                                          </div>
                                          ...
                                          <div className="flex items-center gap-6 pt-4">
                                                 <button
                                                        ...
                                                        className="px-8 py-4 bg-white text-indigo-600 rounded-2xl font-black text-lg shadow-2xl shadow-indigo-900/40 hover:scale-105 transition-transform"
                                                 >
                                                        Find a Specialist
                                                 </button>
                                                 <Link to="/register?role=doctor" className="text-white font-bold hover:underline underline-offset-8">
                     ...
                     {featuredDoctors.length > 0 && (
                            <section className="max-w-7xl mx-auto px-4">
                                   <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                                          <div>
                                                 <h2 className="text-4xl font-black text-gray-900 tracking-tight">Top-Rated Specialists</h2>
                                                 <p className="text-gray-500 mt-2 font-medium">Exceptional care from our highly recommended professionals.</p>
                                          </div>
                                          <button
                                                 onClick={() => navigate('/doctors')}
                                   ...
                                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                                          {featuredDoctors.slice(0, 4).map(doctor => (
                                                 <div
                                                        ...
                                                        className="group bg-white rounded-[32px] p-6 border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-indigo-100 transition-all cursor-pointer transform hover:-translate-y-2"
                                                 >
                     ...
                     {/* Why Choose Us */}
                     <section className="bg-gray-50/50 py-24 rounded-[40px] px-4">
                            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
                                   <div className="bg-white p-10 rounded-[32px] shadow-sm border border-gray-100 hover:shadow-xl transition-all">
                                          ...
                                          <h4 className="text-xl font-black text-gray-900 mb-4">Verified Experts</h4>
                                          <p className="text-gray-500 font-medium leading-relaxed">Every doctor on our platform goes through a multi-stage background and credential check.</p>
                                   </div>
                                   <div className="bg-white p-10 rounded-[32px] shadow-sm border border-gray-100 hover:shadow-xl transition-all">
                                          ...
                                          <h4 className="text-xl font-black text-gray-900 mb-4">Instant Booking</h4>
                                          <p className="text-gray-500 font-medium leading-relaxed">No more waiting in queues. Choose your slot and get confirmed within seconds, 24/7.</p>
                                   </div>
                                   <div className="bg-white p-10 rounded-[32px] shadow-sm border border-gray-100 hover:shadow-xl transition-all">
                                          ...
                                          <h4 className="text-xl font-black text-gray-900 mb-4">Secure Messaging</h4>
                                          <p className="text-gray-500 font-medium leading-relaxed">Chat with your doctors securely before and after appointments for seamless care coordination.</p>
                                   </div>
                            </div>
                     </section>
                     ...
                     {latestReviews.length > 0 && (
                            <section className="max-w-7xl mx-auto px-4 overflow-hidden">
                                   <div className="text-center mb-16">
                                          <h2 className="text-4xl font-black text-gray-900 tracking-tight">Patient Experiences</h2>
                                          <p className="text-gray-500 mt-2 font-medium">Real stories from real patients about our specialists.</p>
                                   </div>

                                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                          {latestReviews.map(review => (
                                                 <div key={review.id} className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm flex flex-col h-full hover:shadow-xl transition-all border-b-4 border-b-indigo-500">
                     ...
                     <section className="px-4">
                            <div className="max-w-5xl mx-auto bg-gray-900 rounded-[40px] p-16 text-center text-white relative overflow-hidden">
                                   ...
                                   <h2 className="text-4xl font-black mb-6">Ready to improve your health?</h2>
                                   <p className="text-gray-400 text-lg max-w-xl mx-auto mb-10 font-medium leading-relaxed">Join thousands of patients who get high-quality healthcare delivered at their convenience.</p>
                                   <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                          <button
                                                 onClick={() => navigate('/doctors')}
                                                 className="w-full sm:w-auto px-10 py-5 bg-indigo-600 rounded-2xl font-black hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-900/40"
                                          >
                                                 Find a Doctor Now
                                          </button>
                                          <button className="w-full sm:w-auto px-10 py-5 bg-white/5 border border-white/10 rounded-2xl font-black hover:bg-white/10 transition-all">
                                                 Learn More
                                          </button>
                                   </div>
                            </div>
